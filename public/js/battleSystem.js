...
battle.addEventListener('click', () => {
  if (playerBattle.value == '' || enemyBattle.value == '') {
  ...
  //Enemys
  let enP = enemyBattle.value
  let enL = enemysForBattle[enemyBattle.value].life
  let enF = enemysForBattle[enemyBattle.value].force
  let enD = enemysForBattle[enemyBattle.value].defense
  ...
  if (coinBattle % 2 == 0) {
    ...
    if ((enL - dam) <= 0) {
      terminalBattle = `${playBattle[playerBattle.value].name} atacou ${enemysForBattle[enemyBattle.value].name} causando ${dam} de dano. ${enemysForBattle[enemyBattle.value].name} morreu. \n${terminalBattle}`
    ...
    enemysForBattle[enP].life = enL - dam
    terminalBattle = `${playBattle[playerBattle.value].name} atacou ${enemysForBattle[enemyBattle.value].name} causando ${dam} de dano. \n${terminalBattle}`
    callTerminal()
    return
  }
  ...
  if (coinBattle % 2 != 0) {
    ...
    if ((plL - dam) <= 0) {
      terminalBattle = `${enemysForBattle[enemyBattle.value].name} atacou ${playBattle[playerBattle.value].name} causando ${dam} de dano. ${playBattle[playerBattle.value].name} morreu. \n${terminalBattle}`
      playerBattle.value = ``
      vs1vs1.value = ``
      callTerminal()
      return
    ...
    enemysForBattle[plP].life = enL - dam
    terminalBattle = `${enemysForBattle[enemyBattle.value].name} atacou ${playBattle[playerBattle.value].name} causando ${dam} de dano. \n${terminalBattle}`
    callTerminal()
    return
  }
})
